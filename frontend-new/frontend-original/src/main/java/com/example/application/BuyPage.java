...
public class BuyPage extends VerticalLayout {
    ...
    public BuyPage() {
        ...
        H2 heading = new H2("🛒 Purchase Courses");
        heading.getStyle()
    ...
    private void displayCoursesInCards(List<Course> courses) {
        ...
        //         System.out.println("  Modules: null");
        //     } else if (course.getModules().isEmpty()) {
        //         System.out.println("  Modules: empty list");
        //     } else {
        //         System.out.println("  Modules found: " + course.getModules().size());
        //         System.out.println("  Modules names: " + course.getModules());
        //         course.getModules().forEach(module -> System.out.println("  Module name: " + module.getName()));
        //     }
        //}
    

        for (Course course : courses) {
            VerticalLayout courseCard = new VerticalLayout();
            courseCard.setWidth("250px");
            courseCard.setHeight("200px");
            courseCard.setSpacing(false);
            courseCard.setPadding(false);
            courseCard.getStyle()
            ...
            if (course.getModules() != null && !course.getModules().isEmpty()) {
                ...
                //Notification.show("Modules not available");
            }
